...
const Dashboard = () => {
  ...
  // 📊 Menu cards data
  const menuItems = [
    { icon: Users, title: 'المرضى', color: 'bg-blue-500', path: '/patients' },
    { icon: Stethoscope, title: 'الأطباء', color: 'bg-green-500', path: '/doctors' },
    { icon: Calendar, title: 'المواعيد', color: 'bg-purple-500', path: '/appointments' },
    { icon: FileText, title: 'الفواتير', color: 'bg-orange-500', path: '/invoices' },
    { icon: TestTube, title: 'المختبر', color: 'bg-red-500', path: '/lab' },
  ];
