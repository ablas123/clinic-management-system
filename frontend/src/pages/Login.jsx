// File: frontend/src/pages/Login.jsx - FIXED
...
const Login = () => {
  ...
  const navigate = useNavigate(); // ✅ هنا صحيح - داخل مكون Route
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4" dir="rtl">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <p className="text-xs text-gray-500 text-center mb-3">تجريبي:</p>
          <div className="grid grid-cols-2 gap-2 text-xs">
            <button type="button" onClick={() => { setEmail('admin@clinic.com'); setPassword('Admin@123'); }} className="p-2 bg-gray-50 hover:bg-gray-100 rounded">Admin</button>
            <button type="button" onClick={() => { setEmail('doctor@clinic.com'); setPassword('Doctor@123'); }} className="p-2 bg-gray-50 hover:bg-gray-100 rounded">Doctor</button>
          </div>
        </div>
      </div>
    </div>
